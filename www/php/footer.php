			...
			<div class="row align-center padding-top-bottom-30">
				<span class="copyright">© Copyright 2025 <a href="https://1.envato.market/renovate-construction-renovation-template" title="Renovate Template" target="_blank">Renovate Template</a> by <a href="https://quanticalabs.com" title="QuanticaLabs" target="_blank">QuanticaLabs</a></span>
			</div>
		</div>
		...
		<?php if(isset($_GET["page"]) && ($_GET["page"]=="contact" || $_GET["page"]=="contact_2")):?>
		<script type="text/javascript" src="//maps.google.com/maps/api/js?key=YOUR_API_KEY&amp;callback=renovateInitMap"></script>
		<?php endif; ?>
